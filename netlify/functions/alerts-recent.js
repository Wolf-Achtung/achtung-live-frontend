...
const SEVERITY_LEVELS = {
 critical: { label: "Kritisch", color: "#800000", icon: "" },
 high: { label: "Hoch", color: "#a60000", icon: "" },
 medium: { label: "Mittel", color: "#a60000", icon: "" },
 low: { label: "Niedrig", color: "#800000", icon: "" }
};
...
const DATA_TYPES = {
 ...
 username: { label: "Benutzername", icon: "" },
